...
## Generated Repository (Advanced Level)

This repository has been generated for the **Advanced** learner level, which includes all Tier 1 + Tier 2 + Tier 3 technologies (175 items total).
...
- `paths/advanced/README.md` as your **main dashboard**
...
- `docs/how-to-use.md`
- `stacks/tiers.md`
- `paths/advanced/README.md` (your dashboard)
...
> `paths/advanced/tracker.md` is a derived artifact and may be overwritten/regenerated by `report.py`.
...
- Keep changes PR-friendly:
  ...
  - Tracker: derived, can be regenerated (`paths/advanced/tracker.md`)
- Prefer small PRs:
